<%-- 
    Document   : viewAdmin
    Created on : Jun 12, 2025, 10:00:00 AM
    Author     : Gemini
--%>
...
<html lang="en">
    <head>
        ...
        <title>CarRent - View Administrator Details</title>
                ...
                <% 
                    ...
                    try {
                        if (userId == null || userId.isEmpty()) {
                            response.sendRedirect("admin-users.jsp?message=Administrator ID not provided&type=danger");
                            return;
                        }
                ...
                <div class="detail-card">
                    ...
                    <div class="details-grid">
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><%= rs.getInt("adminID") %></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">User ID</span>
                            <span class="detail-value"><%= rs.getInt("userID") %></span>
                        </div>
                        <div class="detail-item">
                    ...
                    <div class="action-buttons">
                        <a href="editAdmin.jsp?userID=<%= rs.getString("userID")%>" class="btn btn-warning me-2">
